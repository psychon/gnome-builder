                            ...
                            gpointer      callback_data)
{
  ...
  GTK_CONTAINER_CLASS (ide_shortcuts_group_parent_class)->forall (container, include_internal, forall_cb, &cbdata);
}
...
ide_shortcuts_group_init (IdeShortcutsGroup *self)
{
  ...
  GTK_CONTAINER_CLASS (ide_shortcuts_group_parent_class)->add (GTK_CONTAINER (self), GTK_WIDGET (self->title));
}
