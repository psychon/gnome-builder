                              ...
                              gpointer      callback_data)
{
  ...
  if (include_internal)
    {
      GTK_CONTAINER_CLASS (ide_shortcuts_section_parent_class)->forall (container, include_internal, callback, callback_data);
    }
  else
    {
...
ide_shortcuts_section_init (IdeShortcutsSection *self)
{
  ...
  self->stack = g_object_new (GTK_TYPE_STACK,
                              ...
                              "visible", TRUE,
                              NULL);
  GTK_CONTAINER_CLASS (ide_shortcuts_section_parent_class)->add (GTK_CONTAINER (self), GTK_WIDGET (self->stack));
