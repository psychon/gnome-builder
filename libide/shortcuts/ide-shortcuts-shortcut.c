...
ide_shortcuts_shortcut_init (IdeShortcutsShortcut *self)
{
  ...
  self->image = g_object_new (GTK_TYPE_IMAGE,
                              ...
                              "no-show-all", TRUE,
                              NULL);
  GTK_CONTAINER_CLASS (ide_shortcuts_shortcut_parent_class)->add (GTK_CONTAINER (self), GTK_WIDGET (self->image));
  ...
  self->accelerator = g_object_new (IDE_TYPE_SHORTCUT_LABEL,
                                    ...
                                    "no-show-all", TRUE,
                                    NULL);
  GTK_CONTAINER_CLASS (ide_shortcuts_shortcut_parent_class)->add (GTK_CONTAINER (self), GTK_WIDGET (self->accelerator));
  ...
  self->title_box = g_object_new (GTK_TYPE_BOX,
                                  ...
                                  NULL);
  GTK_CONTAINER_CLASS (ide_shortcuts_shortcut_parent_class)->add (GTK_CONTAINER (self), GTK_WIDGET (self->title_box));
